...
/*   Updated: 2025/04/08 18:29:13 by zel-yama         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void *monitor(void *philo)
{
	...
	while (1)
	{
		...
		if (time >= t->time_d)
		{
			print("died ", p->philo_id, get_the_current(MAIL), t);
			sem_post(t->death);
			sem_wait(t->meal);
			exit(1);
		}
